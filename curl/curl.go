...
// CURLINFO_XXX
const (
    CURLINFO_EFFECTIVE_URL         = C.CURLINFO_EFFECTIVE_URL
    CURLINFO_RESPONSE_CODE         = C.CURLINFO_RESPONSE_CODE
    CURLINFO_TOTAL_TIME            = C.CURLINFO_TOTAL_TIME
    CURLINFO_NAMELOOKUP_TIME       = C.CURLINFO_NAMELOOKUP_TIME
    CURLINFO_CONNECT_TIME          = C.CURLINFO_CONNECT_TIME
    CURLINFO_PRETRANSFER_TIME      = C.CURLINFO_PRETRANSFER_TIME
    CURLINFO_SIZE_UPLOAD           = C.CURLINFO_SIZE_UPLOAD
    CURLINFO_SIZE_DOWNLOAD         = C.CURLINFO_SIZE_DOWNLOAD
    CURLINFO_SPEED_DOWNLOAD        = C.CURLINFO_SPEED_DOWNLOAD
    CURLINFO_SPEED_UPLOAD          = C.CURLINFO_SPEED_UPLOAD
    CURLINFO_HEADER_SIZE           = C.CURLINFO_HEADER_SIZE
    CURLINFO_REQUEST_SIZE          = C.CURLINFO_REQUEST_SIZE
    CURLINFO_SSL_VERIFYRESULT      = C.CURLINFO_SSL_VERIFYRESULT
    CURLINFO_FILETIME              = C.CURLINFO_FILETIME
    CURLINFO_CONTENT_LENGTH_DOWNLOAD = C.CURLINFO_CONTENT_LENGTH_DOWNLOAD
    CURLINFO_CONTENT_LENGTH_UPLOAD = C.CURLINFO_CONTENT_LENGTH_UPLOAD
    CURLINFO_STARTTRANSFER_TIME    = C.CURLINFO_STARTTRANSFER_TIME
    CURLINFO_CONTENT_TYPE          = C.CURLINFO_CONTENT_TYPE
    CURLINFO_REDIRECT_TIME         = C.CURLINFO_REDIRECT_TIME
    CURLINFO_REDIRECT_COUNT        = C.CURLINFO_REDIRECT_COUNT
    CURLINFO_PRIVATE               = C.CURLINFO_PRIVATE
    CURLINFO_HTTP_CONNECTCODE      = C.CURLINFO_HTTP_CONNECTCODE
    CURLINFO_HTTPAUTH_AVAIL        = C.CURLINFO_HTTPAUTH_AVAIL
    CURLINFO_PROXYAUTH_AVAIL       = C.CURLINFO_PROXYAUTH_AVAIL
    CURLINFO_OS_ERRNO              = C.CURLINFO_OS_ERRNO
    CURLINFO_NUM_CONNECTS          = C.CURLINFO_NUM_CONNECTS
    CURLINFO_SSL_ENGINES           = C.CURLINFO_SSL_ENGINES
    CURLINFO_COOKIELIST            = C.CURLINFO_COOKIELIST
    CURLINFO_LASTSOCKET            = C.CURLINFO_LASTSOCKET
    CURLINFO_FTP_ENTRY_PATH        = C.CURLINFO_FTP_ENTRY_PATH
    CURLINFO_REDIRECT_URL          = C.CURLINFO_REDIRECT_URL
    CURLINFO_PRIMARY_IP            = C.CURLINFO_PRIMARY_IP
    CURLINFO_APPCONNECT_TIME       = C.CURLINFO_APPCONNECT_TIME
    CURLINFO_CERTINFO              = C.CURLINFO_CERTINFO
    CURLINFO_CONDITION_UNMET       = C.CURLINFO_CONDITION_UNMET
    CURLINFO_RTSP_SESSION_ID       = C.CURLINFO_RTSP_SESSION_ID
    CURLINFO_RTSP_CLIENT_CSEQ      = C.CURLINFO_RTSP_CLIENT_CSEQ
    CURLINFO_RTSP_SERVER_CSEQ      = C.CURLINFO_RTSP_SERVER_CSEQ
    CURLINFO_RTSP_CSEQ_RECV        = C.CURLINFO_RTSP_CSEQ_RECV
    CURLINFO_PRIMARY_PORT          = C.CURLINFO_PRIMARY_PORT
    CURLINFO_LOCAL_IP              = C.CURLINFO_LOCAL_IP
    CURLINFO_LOCAL_PORT            = C.CURLINFO_LOCAL_PORT
    CURLINFO_TLS_SESSION           = C.CURLINFO_TLS_SESSION
)
