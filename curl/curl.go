...
// PROTO_XXX
const (
    PROTO_HTTP                     = C.CURLPROTO_HTTP
    PROTO_HTTPS                    = C.CURLPROTO_HTTPS
    PROTO_FTP                      = C.CURLPROTO_FTP
    PROTO_FTPS                     = C.CURLPROTO_FTPS
    PROTO_SCP                      = C.CURLPROTO_SCP
    PROTO_SFTP                     = C.CURLPROTO_SFTP
    PROTO_TELNET                   = C.CURLPROTO_TELNET
    PROTO_LDAP                     = C.CURLPROTO_LDAP
    PROTO_LDAPS                    = C.CURLPROTO_LDAPS
    PROTO_DICT                     = C.CURLPROTO_DICT
    PROTO_FILE                     = C.CURLPROTO_FILE
    PROTO_TFTP                     = C.CURLPROTO_TFTP
    PROTO_IMAP                     = C.CURLPROTO_IMAP
    PROTO_IMAPS                    = C.CURLPROTO_IMAPS
    PROTO_POP3                     = C.CURLPROTO_POP3
    PROTO_POP3S                    = C.CURLPROTO_POP3S
    PROTO_SMTP                     = C.CURLPROTO_SMTP
    PROTO_SMTPS                    = C.CURLPROTO_SMTPS
    PROTO_RTSP                     = C.CURLPROTO_RTSP
    PROTO_RTMP                     = C.CURLPROTO_RTMP
    PROTO_RTMPT                    = C.CURLPROTO_RTMPT
    PROTO_RTMPE                    = C.CURLPROTO_RTMPE
    PROTO_RTMPTE                   = C.CURLPROTO_RTMPTE
    PROTO_RTMPS                    = C.CURLPROTO_RTMPS
    PROTO_RTMPTS                   = C.CURLPROTO_RTMPTS
    PROTO_GOPHER                   = C.CURLPROTO_GOPHER
    PROTO_SMB                      = C.CURLPROTO_SMB
    PROTO_SMBS                     = C.CURLPROTO_SMBS
    PROTO_ALL                      = C.CURLPROTO_ALL
)
